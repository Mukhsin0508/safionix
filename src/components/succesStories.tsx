...
export default function SuccessStories({ className }: Props) {
  return (
    <div className={className} >
      ...
      <a
        href="https://speaklish.co"
        target="_blank"
        rel="noopener noreferrer"
        className="block "
      >
        <div className="w-[1145px] h-[580px] hover:mt-[20px] transition-all duration-500 ease-in-out mx-auto mt-10 rounded-3xl bg-[#FAFAFA] relative flex flex-col justify-center items-center">
          <div className="flex gap-7 ">
            <div className="w-[532px] h-[532px] bg-white flex rounded-2xl"></div>
