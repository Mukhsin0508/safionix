...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium ring-offset-background transition-all duration-250 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-color2 text-dsgWhiteMain hover:bg-color7",
        destructive:
          "bg-destructive text-destructive-foreground hover:bg-destructive/90",
        outline:
          "border border-input bg-background hover:bg-accent hover:text-accent-foreground",
        secondary:
          "bg-dsgWhiteMain text-dsgBlackMain hover:bg-secondary/80",
        ghost: "text-dsgWhiteMain border-b border-dsgWhiteMain",
        link: "text-primary underline-offset-4 hover:underline",
        tertiary: "bg-color4 text-dsgWhiteMain hover:opacity-90",
      },
      size: {
