...
import MyCertificatesPdfComp from "@/components/MyCertificatesPdfComp"
    ...
    <>
      ...
      <main className="mt-7.5 flex gap-[24px]">
        <div className="max-w-[287px] flex flex-col gap-6">
          <TimeDisplay hours={23} minutes={28} seconds={55} stop />
          <Link
